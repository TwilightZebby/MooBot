...
module.exports = {
    ...
    description: `Used to edit a Role Button on an existing Menu`,
    ...
    async execute(buttonInteraction)
    {
        ...
        let editRoleModal = new Discord.Modal().setCustomId(`editrolebutton_${roleID}`).setTitle("Edit Role Button").addComponents([
