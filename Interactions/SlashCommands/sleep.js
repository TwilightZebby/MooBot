...
module.exports = {
    ...
    Description: `Tell someone to go to sleep already!`,
        ...
        Data.options = [
            {
                ...
                name: "person",
                description: "Person you think needs sleep",
                required: true
            },
            {
            ...
            },
            {
                type: Discord.ApplicationCommandOptionType.Boolean,
                name: "button",
                description: "Should the \"Return Sleep\" Button be included? (default: true)",
                required: false
            },
            {
