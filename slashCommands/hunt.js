...
module.exports = {
    name: 'hunt',
    description: `Hunt down your foes during the brightest full moon!`,
        ...
        data.options = [
            {
                type: "USER",
                name: "person",
                description: "The person you want to hunt down",
                required: true
            },
            {
                type: "STRING",
    ...
    async execute(slashInteraction) {
        ...
        displayMessage = SPOOKYMESSAGES[`werewolves`];
